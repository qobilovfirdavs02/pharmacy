...
class Breadcrumb_Trail {
	...
	public function trail() {
		...
		$breadcrumb    = '';
		$item_count    = is_array( $this->items ) ? count( $this->items ) : 0;
		$item_position = 0;
	...
	protected function add_term_archive_items() {
		...
		if ( false === $done_post_type &&  is_array($taxonomy->object_type) && 1 === count( $taxonomy->object_type ) && post_type_exists( $taxonomy->object_type[0] ) ) {
